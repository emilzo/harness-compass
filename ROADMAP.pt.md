...
- [x] **Decisão de evidência (P0 do review externo) — resolvida:** relatório do Hermes **publicado integralmente** (`docs/DEEP-HARNESS-AUDIT-HERMES.md`, edição pública com paths locais normalizados + nota de cortesia OSS) · Kando mantido como **Estimativa** com sumário público (`docs/EVIDENCE-SUMMARY-KANDO.md`; auditado internamente, em preparação para go-to-market, relatório linha a linha privado)
